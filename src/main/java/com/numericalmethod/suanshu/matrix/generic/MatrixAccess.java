 ...
 * The <em>only</em> way to change a matrix is by calling {@link #set(int, int, com.numericalmethod.suanshu.mathstructure.Field)}.
...
public interface MatrixAccess<F extends Field<F>> {//TODO: extends Cloneable, java.io.Serializable {
     ...
     */
    public void set(int i, int j, F value) throws MatrixAccessException;
     ...
     * @throws MatrixAccessException if <i>i</i> or <i>j</i> is out of range
     */
    public F get(int i, int j) throws MatrixAccessException;
}
