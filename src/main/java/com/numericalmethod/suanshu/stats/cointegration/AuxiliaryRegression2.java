 ...
 * <blockquoteicode>
 * Y_t = μ + Σ[Γ_i * ΔY_{t-i}] + ψ * D_t + ε_t, (i = 1, 2, ..., p-1),
 * </i></blockquote>
...
class AuxiliaryRegression2 extends AuxiliaryRegression {
     ...
     */
    AuxiliaryRegression2(SimpleMultiVariateTimeSeries ts, int p, Matrix D, boolean addIntercept) {
        super(ts, p, D, addIntercept);
    }

    @Override
    Matrix getRegressand() {
        return new DenseMatrix(ts.toMatrix());
    }
}
