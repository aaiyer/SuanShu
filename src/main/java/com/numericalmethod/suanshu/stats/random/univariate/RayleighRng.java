...
public class RayleighRng extends InverseTransformSampling {
    ...
    public RayleighRng(double sigma, RandomLongGenerator rng) {
        super(new com.numericalmethod.suanshu.stats.distribution.univariate.RayleighDistribution(sigma), rng);
    }
    ...
    public RayleighRng(double sigma) {
        super(new com.numericalmethod.suanshu.stats.distribution.univariate.RayleighDistribution(sigma), new UniformRng());
    }
}
