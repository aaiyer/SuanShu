...
public class ConcurrentCachedRVG implements RandomVectorGenerator {
     ...
     *
     * @param rvg       the underlying generator
     ...
     */
    public ConcurrentCachedRVG(final RandomVectorGenerator rvg, int cacheSize) {
        this.rvg = rvg;
    ...
    public ConcurrentCachedRVG(RandomVectorGenerator rvg) {
        this(rvg, Runtime.getRuntime().availableProcessors() * 8);
    }
