...
public class AbsoluteError extends MultiplierPenalty {
     ...
     */
    public AbsoluteError(EqualityConstraints constraints, double[] weights) {
        super(constraints, weights);
    }

    /**
     * Construct an absolute error penalty function from a collection of equality constraints.
     * This assigns the same weight to all constraints.
     *
     * @param constraints a collection of equality constraints
     * @param weight      the same weight assigned to all constraints
     */
    public AbsoluteError(EqualityConstraints constraints, double weight) {
