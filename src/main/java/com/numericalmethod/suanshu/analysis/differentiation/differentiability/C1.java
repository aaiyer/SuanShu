...
/**
 * A function, <i>f</i>, is said to be of class C<sup>1</sup> if the derivative <i>f'</i> exists.
 *
 * @author Haksun Li
 * @see <a href="http://en.wikipedia.org/wiki/Smooth_function">Wikipedia: Smooth function</a>
 */
public interface C1 {//extends RealVectorFunction?

    /**
     * Get the gradient function, <i>g</i>, of a real valued function <i>f</i>.
     *
