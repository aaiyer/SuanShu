...
public class PearsonTest {
     ...
     *
     * Pearson seems to take more iterations and produces less precision than RankOne does.
     */
    @Test
    public void test_0010() throws Exception {
        ...
        Pearson optim = new Pearson(1e-6, 13);
...
//        System.out.println(xmin);
        ...
        Vector ans = new DenseVector(new double[]{3.00000000004599, 1.99999999991637});//from matlab
...
//        System.out.println(fxmin);
     ...
     *
     * Pearson seems to take more iterations and produces less precision than RankOne does.
     * It is also very sensitive to the initial values.
     */
    @Test
    public void test_0030() throws Exception {
        ...
        Pearson optim1 = new Pearson(1e-15, 50);
...
//        System.out.println(fxmin);
        ...
        Pearson optim2 = new Pearson(1e-15, 200);
