...
public class RankOneTest {
    ...
    public void test_0010() throws Exception {
        ...
        RankOne optim = new RankOne(1e-15, 11);
...
//        System.out.println(xmin);
        ...
        Vector ans = new DenseVector(new double[]{3.00000000004948, 1.99999999995349});//from matlab
...
//        System.out.println(fxmin);
     ...
     *
     * RankOne method have better convergence properties and is more robust
     * than those of Zangwill's.
     */
    @Test
    public void test_0030() throws Exception {
        ...
        RankOne optim1 = new RankOne(1e-15, 43);
...
//        System.out.println(fxmin);
        ...
        RankOne optim2 = new RankOne(1e-15, 47);
