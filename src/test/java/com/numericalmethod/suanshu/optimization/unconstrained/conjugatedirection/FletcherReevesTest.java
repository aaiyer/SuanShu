 ...
 * @author Haksun Li
 */
public class FletcherReevesTest {
    ...
    public void test_0010() throws Exception {
        ...
        FletcherReeves optim = new FletcherReeves(1e-6, 40000);
...
//        System.out.println(xmin);
        ...
        Vector ans = new DenseVector(3.00000006180567, 2.00000011164220);//from matlab
        double fans = f.evaluate(ans);
//        System.out.println(ans);
//        System.out.println(fans);

        assertEquals(0.0, xmin.minus(ans).norm(), 1e-12);
...
//        System.out.println(fxmin);
    ...
    public void test_0020() throws Exception {
        ...
        Vector xmin = soln.search(new DenseVector(6., 6.));
     ...
     * FletcherReeves seems to have less precision than ......
     */
    @Test
    public void test_0040() throws Exception {
        ...
        FletcherReeves optim = new FletcherReeves(1e-6, 40000);
        IterativeMinimizer<Vector> soln = optim.solve(new C2OptimProblemImpl(f, g));
        Vector xmin = soln.search(new DenseVector(1., -1., -1., 1.));
//        System.out.println(xmin);
        double fxmin = f.evaluate(xmin);
//        System.out.println(fxmin);
        assertEquals(0.0, fxmin, 1e-7);//not as good convergence properties as in FletcherReeves
...
//        System.out.println(f.evaluate(ans));
        ...
        xmin = soln.search(new DenseVector(2., 10., -15., 17.));
//        System.out.println(xmin);
        fxmin = f.evaluate(xmin);
//        System.out.println(fxmin);
        assertEquals(0.0, fxmin, 1e-6);//not as good convergence properties as in FletcherReeves
    }
}
