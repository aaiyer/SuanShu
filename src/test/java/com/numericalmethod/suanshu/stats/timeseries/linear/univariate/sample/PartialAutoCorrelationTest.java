 ...
 * @author Haksun Li
 */
public class PartialAutoCorrelationTest {

    /**
     * example 2.5 from William W.S. Wei
     */
    @Test
    public void test_0010() {
        ...
        PartialAutoCorrelation instance = new PartialAutoCorrelation(xt, AutoCovariance.Type.TYPE_I);
        assertEquals(-.188, instance.evaluate(1), 1e-3);
        assertEquals(-.245, instance.evaluate(2), 1e-3);
        assertEquals(.097, instance.evaluate(3), 1e-3);
    }
    ...
    acf(x, lag.max = 20, type = "partial", plot = FALSE)
     *
     */
    @Test
    public void test_0030() {
        ...
        assertEquals(0.092, instance.evaluate(3), 1e-3);
        assertEquals(-0.025, instance.evaluate(4), 1e-3);
        assertEquals(0.136, instance.evaluate(5), 1e-3);
        assertEquals(-0.018, instance.evaluate(6), 1e-3);
        assertEquals(0.111, instance.evaluate(7), 1e-3);
        assertEquals(-0.103, instance.evaluate(8), 1e-3);
        assertEquals(-0.096, instance.evaluate(9), 1e-3);
        assertEquals(0.080, instance.evaluate(10), 1e-3);
        assertEquals(-0.059, instance.evaluate(11), 1e-3);
        assertEquals(-0.018, instance.evaluate(12), 1e-3);
        assertEquals(-0.077, instance.evaluate(13), 1e-3);
        assertEquals(-0.054, instance.evaluate(14), 1e-3);
        assertEquals(-0.088, instance.evaluate(15), 1e-3);
        assertEquals(-0.097, instance.evaluate(16), 1e-3);
        assertEquals(0.020, instance.evaluate(17), 1e-3);
        assertEquals(-0.004, instance.evaluate(18), 1e-3);
        assertEquals(-0.173, instance.evaluate(19), 1e-3);
        assertEquals(-0.038, instance.evaluate(20), 1e-3);
    }
    ...
    public void test_0040() {
        ...
        assertEquals(-0.088, instance.evaluate(15), 1e-3);//make sure this was computed
    }
}
