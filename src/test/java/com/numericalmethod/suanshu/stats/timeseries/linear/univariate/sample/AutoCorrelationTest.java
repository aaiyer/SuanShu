...
public class AutoCorrelationTest {
    ...
    acf(x, lag.max = 20, type = "correlation", plot = FALSE)
     *
     */
    @Test
    public void test_0010() {
        ...
        AutoCorrelation instance = new AutoCorrelation(xt, AutoCovariance.Type.TYPE_I);
        assertEquals(1, instance.evaluate(0), 1e-3);
        assertEquals(0.029, instance.evaluate(1), 1e-3);
        assertEquals(0.023, instance.evaluate(2), 1e-3);
        assertEquals(0.093, instance.evaluate(3), 1e-3);
        assertEquals(-0.019, instance.evaluate(4), 1e-3);
        assertEquals(0.138, instance.evaluate(5), 1e-3);
        assertEquals(-0.002, instance.evaluate(6), 1e-3);
        assertEquals(0.107, instance.evaluate(7), 1e-3);
        assertEquals(-0.065, instance.evaluate(8), 1e-3);
        assertEquals(-0.107, instance.evaluate(9), 1e-3);
        assertEquals(0.108, instance.evaluate(10), 1e-3);
        assertEquals(-0.074, instance.evaluate(11), 1e-3);
        assertEquals(-0.008, instance.evaluate(12), 1e-3);
        assertEquals(-0.075, instance.evaluate(13), 1e-3);
        assertEquals(-0.089, instance.evaluate(14), 1e-3);
        assertEquals(-0.079, instance.evaluate(15), 1e-3);
        assertEquals(-0.142, instance.evaluate(16), 1e-3);
        assertEquals(0.033, instance.evaluate(17), 1e-3);
        assertEquals(-0.049, instance.evaluate(18), 1e-3);
        assertEquals(-0.206, instance.evaluate(19), 1e-3);
        assertEquals(-0.047, instance.evaluate(20), 1e-3);
    }
}
