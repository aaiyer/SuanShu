...
import com.numericalmethod.suanshu.stats.random.univariate.gamma.XiTanLiu2010b;
 ...
 * @author Haksun Li
 */
public class VanDerWaerden1969Test {
    ...
    public void test_0010() {
        ...
        VanDerWaerden1969 rng = new VanDerWaerden1969(alpha, beta);
        ...
        assertEquals(dist.skew(), skew.value(), 0.01);
        assertEquals(dist.kurtosis(), kurtosis.value(), 0.01);
    }
    ...
    public void test_0030() {
        ...
        assertEquals(dist.variance(), var.value(), 0.001);
        assertEquals(dist.skew(), skew.value(), 0.002);
        assertEquals(dist.kurtosis(), kurtosis.value(), 0.1);
    }

    /**
     * TODO:
     * The Gamma generators seem to produce wrong (negative) values for small alpha, beta.
     */
//    @Test
    public void test_0040() {
        ...
        VanDerWaerden1969 rng = new VanDerWaerden1969(
                new XiTanLiu2010b(alpha),
                new XiTanLiu2010b(beta));
        rng.seed(1234567890L);
