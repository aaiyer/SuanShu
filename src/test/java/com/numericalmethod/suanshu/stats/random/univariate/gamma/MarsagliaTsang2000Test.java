 ...
 * @author Haksun Li
 */
public class MarsagliaTsang2000Test {
    ...
    public void test_0010() {
        ...
        MarsagliaTsang2000 rng = new MarsagliaTsang2000(k, theta, new BoxMuller(), new UniformRng());
    ...
    public void test_0020() {
        ...
        assertEquals(dist.skew(), skew.value(), 0.01);
        assertEquals(dist.kurtosis(), kurtosis.value(), 0.08);
    }
    ...
    public void test_0030() {
        ...
        assertEquals(dist.kurtosis(), kurtosis.value(), 1);
    }
}
