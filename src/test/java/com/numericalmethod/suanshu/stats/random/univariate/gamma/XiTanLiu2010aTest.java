 ...
 * @author Haksun Li
 */
public class XiTanLiu2010aTest {
    ...
    public void test_0010() {
        ...
        XiTanLiu2010a rng = new XiTanLiu2010a(k, new UniformRng());
        ...
        assertEquals(dist.kurtosis(), kurtosis.value(), 0.05);
    }
    ...
    public void test_0030() {
        ...
        ProbabilityDistribution dist = new GammaDistribution(k, 1);
        assertEquals(dist.mean(), mean.value(), 0.003);
        assertEquals(dist.variance(), var.value(), 0.03);
        assertEquals(dist.skew(), skew.value(), 0.01);
        assertEquals(dist.kurtosis(), kurtosis.value(), 0.05);
    }
    ...
    public void test_0060() {
        ...
        assertEquals(dist.mean(), mean.value(), 0.001);
        assertEquals(dist.variance(), var.value(), 0.003);
        assertEquals(dist.skew(), skew.value(), 0.06);
    ...
    public void test_0070() {
        ...
        assertEquals(dist.mean(), mean.value(), 0.001);
        assertEquals(dist.variance(), var.value(), 0.003);
        assertEquals(dist.skew(), skew.value(), 30);
