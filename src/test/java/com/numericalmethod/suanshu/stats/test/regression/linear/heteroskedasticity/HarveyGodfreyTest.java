 ...
 * @author Haksun Li
 */
public class HarveyGodfreyTest {
    ...
    public void test_0010() {
        ...
        HarveyGodfrey instance = new HarveyGodfrey(ols.residuals);

        assertEquals(1.3965975653858274, instance.statistics(), 1e-3);//TODO: from debugger; vs. 1.4286 comparing to Breusch-Pagan
        assertEquals(0.23729408075310354, instance.pValue(), 1e-3);//TODO: from debugger; vs. 0.232 comparing to Breusch-Pagan
    }
}
