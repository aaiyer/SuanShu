...
public class ExponentialTest {
    ...
    public void testChangeOfVariable_0010() {
        ...
        assertEquals(1, result, 1e-1);//very poor approximation when the integrand does not falls expoentially
    }
    ...
    public void testChangeOfVariable_0020() {
        ...
        assertEquals(0.5 * sqrt(PI), result, 1e-6);
    }
